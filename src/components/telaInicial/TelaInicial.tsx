            ...
            <BackgroundBeamsWithCollision>
                <div className="flex flex-col justify-center items-center z-20 p-4">
                    ...
                    <div className="grid grid-cols-2 gap-2 text-white mt-4 font-primaria">
                        ...
                        <Link href={usuario ? '/menuUsuario/novoPedido' : '/login'} className="grid grid-cols-[35px_1fr] p-1 bg-azul gap-2 rounded-md md:flex md:justify-center md:p-2">
                            <FaShippingFast className="text-3xl mx-auto my-auto md:mx-0" />
                            <p className="line-clamp-3 leading-5 uppercase font-bold text-center my-auto mx-0">Faça um pedido/coleta</p>
                        </Link>
                        <Link href={'/login'} className="col-start-1 col-end-3 bg-azul-escuro py-2 md:py-4">
